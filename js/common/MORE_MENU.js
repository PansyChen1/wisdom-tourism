...
export const MORE_MENU = {
  Custom_Language: {name: '设置', Icons: AntDesign, icon: 'setting'},
  Sort_Language: {name: '离线缓存', Icons: AntDesign, icon: 'download'},
  Custom_Theme: {name: '我的游记', Icons: Ionicons, icon: 'ios-color-palette'},
  ...
  CodePush: {name: '民宿', Icons: Ionicons, icon: 'ios-planet'},
};